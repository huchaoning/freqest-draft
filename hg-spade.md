...
模拟使用的参数和实验一致, 结果如下, 首先是无噪声的情况

<img src="hg-spade.assets/image-20250530123511647.png" alt="image-20250530123511647" style="zoom:33%;" />

可以看到, 虽然大体上能够和 CRB 对上, 但是 HG-SPADE 整体总是比 CRB 低一些. 而 PM-SPADE 和 DI 稍微好一些. 这个问题的原因暂时不知道.

<img src="hg-spade.assets/image-20250530122457328.png" alt="image-20250530122457328" style="zoom:33%;" />

可以看到, 模拟结果和 CRB 符合良好. 模拟中, 一共使用 20 个 HG 模式作为测量基 (HG0 至 HG19). 但是暂时还不知道为什么 DI 和 CRB符合更好, 这点与实验略有区别. 原因也暂时不知道.
